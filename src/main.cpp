...
#include "Demo_OGL_III/Demo_OGL_3ocl.h"
...
int main(int argc, char* argv[]) {
	return mainDemo_OGL_IIIOCL();
}

int mainDemo_OGL_IIIOCL(){
	std::cout << "\t Demo Output: " << std::endl;
    Demo_OGL_3OCL* d = new Demo_OGL_3OCL();
    return d->Execute();
}
...
int mainOCL(void) {
    ...
    char param_value[200];
    size_t param_value_size = 200;
    ...
    ret = clGetPlatformInfo(platforms[0],
        CL_PLATFORM_VENDOR,
        200 * sizeof(char),
        param_value,
        &param_value_size);
